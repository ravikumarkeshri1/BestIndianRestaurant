...
class ListingManagerByQuery extends StatelessWidget {
  ...
  ListingManagerByQuery(this.fetchedProductList, this.fetchListingId,
      this.userName, this.currentImage,this.email) {
    // this.fetchedProductList=fetchedProductList;
    // this.fetchListingId=fetchListingId;
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: AppBar(
          title: Text('Top Restaurant By Selected Country'),
